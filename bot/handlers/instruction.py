...
async def detailed_instruction_handler(callback: types.CallbackQuery):
    ...
    instructions = {
        "ios": (
            ...
            "3. Откройте v2RayTun, нажмите «+» и выберите «Импорт из буфера обмена».\n"
            "4. Подключитесь и работайте без ограничений. 🔒"
        ),
        "android": (
            "<b>🤖 Android</b>\n\n"
            "1. Установите приложение v2RayNG: "
            "<b><a href='https://play.google.com/store/apps/details?id=com.v2ray.ang'>Скачать</a></b>\n"
            "2. Получите ключ (ссылку) для подключения.\n"
        ...
        "windows": (
            ...
            "<b><a href='https://hidify.com/download'>Скачать</a></b>\n"
            "2. Получите ключ (ссылку) для подключения.\n"
            "3. Откройте Hidify VPN и добавьте подключение, вставив ключ.\n"
        ...
        "tv": (
            "<b>📺 Android TV</b>\n\n"
            "1. Установите приложение <b>v2RayNG</b> на телевизор: "
            "<b><a href='https://play.google.com/store/apps/details?id=com.v2ray.ang'>Скачать</a></b>\n"
            "2. Получите ключ (ссылку) для подключения.\n"
